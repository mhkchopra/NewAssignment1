...
public class ViewPaySlipp extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewPaySlipp frame = new ViewPaySlipp();
	...
	public ViewPaySlipp() {
		...
		JLabel lblSalarySlipFor = new JLabel("Salary Slip for August Month");
		lblSalarySlipFor.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblSalarySlipFor.setBounds(187, 21, 258, 37);
		contentPane.add(lblSalarySlipFor);
